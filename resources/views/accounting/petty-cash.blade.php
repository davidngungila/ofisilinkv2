...
<div class="space-y-6">
    <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
        ...
        <div class="bg-gray-50 rounded-lg p-6">
            ...
            <p class="text-sm text-gray-500 text-center">This module includes: Imprest Request & Retirement, automated workflows, multi-level approvals, and real-time reporting.</p>
        </div>
    </div>
</div>
@endsection
