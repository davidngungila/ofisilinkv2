...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-600 mb-1">Pending Assignments</p>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <div class="p-6 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">Create, assign, and manage tasks with multi-level hierarchy</p>
                </div>
                ...
                <thead class="bg-gray-50 border-b border-gray-200">
                    <tr>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                            <input type="checkbox" class="rounded border-gray-300 text-[#940000] focus:ring-[#940000]">
                        </th>
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                <div>
                                    ...
                                    <div class="text-sm text-gray-500">TASK-2025-001</div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                <div>
                                    ...
                                    <div class="text-sm text-gray-500">TASK-2025-002</div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="text-sm text-gray-900">Mobile App Development</span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                <div>
                                    ...
                                    <div class="text-sm text-gray-500">TASK-2025-003</div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="text-sm text-gray-900">Financial Planning</span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                <div>
                                    ...
                                    <div class="text-sm text-gray-500">TASK-2025-004</div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="text-sm text-gray-900">HR Development</span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                <div>
                                    ...
                                    <div class="text-sm text-gray-500">TASK-2025-005</div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
        ...
        <div class="px-6 py-4 border-t border-gray-200 bg-gray-50 flex items-center justify-between">
            <div class="text-sm text-gray-700">
                Showing <span class="font-medium">1</span> to <span class="font-medium">5</span> of <span class="font-medium">247</span> tasks
            </div>
            <div class="flex items-center space-x-2">
